...
@WebServlet(name = "SEmpresaListar", urlPatterns = {"/SEmpresaListar"})
public class SEmpresaListar extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(SEmpresaListar.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(Utilidades.get().autenticado(sesion)){
            ...
            try{
                ...
                Utilidades.get().generaLogServer(LOG, Level.SEVERE, "Error en SEmpresaListar {0}", new Object[]{eg.getMessage()});
