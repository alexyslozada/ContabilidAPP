...
@MultipartConfig
@WebServlet(name = "SCuentasPucEliminar", urlPatterns = {"/SCuentasPucEliminar"})
public class SCuentasPucEliminar extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(SCuentasPucEliminar.class.getName());
        ...
        if (Utilidades.get().autenticado(sesion)) {
            ...
            if (dao.tienePermiso(usuario.getPerfil(), dao.OBJETO, Constantes.BORRAR)) {
                ...
                try{
                    ...
                    Utilidades.get().generaLogServer(LOG, Level.SEVERE, "Error en SCuentasPucEliminar {0}", new Object[]{eg.getMessage()});
