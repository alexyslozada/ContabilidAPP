...
@MultipartConfig
@WebServlet(name = "STipoIdentificacionEliminar", urlPatterns = {"/STipoIdentificacionEliminar"})
public class STipoIdentificacionEliminar extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(STipoIdentificacionEliminar.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(Utilidades.get().autenticado(sesion)){
            ...
            if(dao.tienePermiso(usuario.getPerfil(), dao.OBJETO, Constantes.BORRAR)){
                ...
                try{
                    boolean respuesta = dao.eliminar(Utilidades.get().parseShort(ide, LOG, true));
                    ...
                    Utilidades.get().generaLogServer(LOG, Level.SEVERE, "Error en STipoIdentificacionEliminar {0}", new Object[]{eg.getMessage()});
