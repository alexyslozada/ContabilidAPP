...
@WebServlet(name = "SRegContableCancelar", urlPatterns = {"/SRegContableCancelar"})
public class SRegContableCancelar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        byte tipo = Constantes.MSG_CORRECTO;
        String mensaje = "Cancelación realizada";
        String objeto = "";
