...
@MultipartConfig
@WebServlet(name = "SCentroCostoEliminar", urlPatterns = {"/SCentroCostoEliminar"})
public class SCentroCostoEliminar extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(SCentroCostoEliminar.class.getName());
        ...
        if (Utilidades.get().autenticado(sesion)) {
            ...
            if (dao.tienePermiso(usuario.getPerfil(), dao.OBJETO, Constantes.BORRAR)) {
                ...
                try{
                    ...
                    Utilidades.get().generaLogServer(LOG, Level.SEVERE, "Error en SCentroCostoEliminar {0}", new Object[]{eg.getMessage()});
