...
@MultipartConfig
@WebServlet(name = "STipoFuncionarioActualizar", urlPatterns = {"/STipoFuncionarioActualizar"})
public class STipoFuncionarioActualizar extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(STipoFuncionarioActualizar.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(Utilidades.get().autenticado(sesion)){
            ...
            if(dao.tienePermiso(usuario.getPerfil(), dao.OBJETO, Constantes.MODIFICAR)){
                ...
                TipoFuncionario tipoFuncionario = new TipoFuncionario(sId, nombre);
                
                try{
                    boolean respuesta = dao.actualizar(tipoFuncionario);
                    ...
                    Utilidades.get().generaLogServer(LOG, Level.SEVERE, "Error en STipoFuncionarioActualizar {0}", new Object[]{eg.getMessage()});
